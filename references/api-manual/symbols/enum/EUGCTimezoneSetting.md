...
- Symbol Type: enum
- Symbol Path: EUGCTimezoneSetting
- Source JSON Path: cppenum/detail/EUGCTimezoneSetting.json
- Source JSON URL: https://developer.gp.qq.com/api/cppenum/detail/EUGCTimezoneSetting.json
