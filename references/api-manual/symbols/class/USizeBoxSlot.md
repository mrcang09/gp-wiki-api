...
- Symbol Type: class
- Symbol Path: Others / USizeBoxSlot
- Source JSON Path: class/detail/Others/USizeBoxSlot.json
- Source JSON URL: https://developer.gp.qq.com/api/class/detail/Others/USizeBoxSlot.json
