...
- Symbol Type: class
- Symbol Path: Others / UBorderSlot
- Source JSON Path: class/detail/Others/UBorderSlot.json
- Source JSON URL: https://developer.gp.qq.com/api/class/detail/Others/UBorderSlot.json
