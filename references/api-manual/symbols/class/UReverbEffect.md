...
- Symbol Type: class
- Symbol Path: Others / UReverbEffect
- Source JSON Path: class/detail/Others/UReverbEffect.json
- Source JSON URL: https://developer.gp.qq.com/api/class/detail/Others/UReverbEffect.json
