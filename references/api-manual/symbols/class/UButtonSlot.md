...
- Symbol Type: class
- Symbol Path: Others / UButtonSlot
- Source JSON Path: class/detail/Others/UButtonSlot.json
- Source JSON URL: https://developer.gp.qq.com/api/class/detail/Others/UButtonSlot.json
