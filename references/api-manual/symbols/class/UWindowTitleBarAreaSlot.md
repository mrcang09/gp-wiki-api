...
- Symbol Type: class
- Symbol Path: Others / UWindowTitleBarAreaSlot
- Source JSON Path: class/detail/Others/UWindowTitleBarAreaSlot.json
- Source JSON URL: https://developer.gp.qq.com/api/class/detail/Others/UWindowTitleBarAreaSlot.json
